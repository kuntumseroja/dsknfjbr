...
CHINCODE_NAME="diskominfoassetLedgerContract"
...
echo
echo "Deploy smart contract Diskominfo Asset Ledger Network (DALN) fabric blockchain"
echo
...
echo
echo "========= Diskominfo Asset Ledger Network (DALN) contract successfully deployed on channel $CHANNEL_NAME  =========== "
